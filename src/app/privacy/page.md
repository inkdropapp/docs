...
When you [shared notes](/reference/share-notes-on-the-web) to the World Wide Web, Inkdrop collects the contents of the note without encryption, plus metadata, including your account data in order to make the note available to everyone, online.
...
You can also access to the Inkdrop database directly via [the Data Access API](https://developers.inkdrop.app/guides/access-the-local-database) which is compatible with [CouchDB](http://couchdb.apache.org/).
